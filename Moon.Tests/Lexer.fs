...
let ``Given lexeme, should tokenize to given Token`` token lexeme =
    let tokenized = tokenized lexeme
...
let ``Given text with inline comment, then properly tokenized``() =
    ...
    let expected: Token list =
        [ { tokenType = LineComment "// This is a line comment\n"
...
"
    ...
    let tokens = tokenize (InputType.Text text)
    ...
    let expected =
        [ { tokenType = BlockComment "/*\n  This is\n  a\n  block comment\n*/"
          ...
          { tokenType = Comma
            location = { line = 14; column = 8 } }
          { tokenType = Id "b"
            location = { line = 14; column = 9 } }
          { tokenType = Comma
            location = { line = 14; column = 10 } }
          { tokenType = Id "c"
            location = { line = 14; column = 11 } }
          { tokenType = ClosedBracket
            location = { line = 14; column = 12 } }
          { tokenType = SemiColon
            location = { line = 14; column = 13 } }
        ]
        
    Utils.write (tokens |> List.map (fun e -> string e) |> String.concat "\n") (Utils.makePath "tokens.txt") 
    Utils.write (expected |> List.map (fun e -> string e) |> String.concat "\n") (Utils.makePath "expected.txt")
...
let validCases =
    Utils.asTestArguments
        [ [ LineComment "// This is a line comment\n"; "// This is a line comment\n" ]
          ...
          [ Nonzero "2"; "2" ]
          [ Digit "0"; "0" ]
          [ IntegerLiteral "8323"; "8323" ]
          [ Fraction ".024"; ".024" ]
          [ Fraction ".0" ; ".0" ]
          [ FloatLiteral "1.1" ; "1.1" ]
          [ Alphanum "a" ; "a" ]
          [ Id "a___" ; "a___" ]
          [ BlockComment "/**/" ; "/**/" ]
          [ BlockComment "/* */" ; "/* */" ]
          [ BlockComment "/* This is a block comment */" ; "/* This is a block comment */" ]
